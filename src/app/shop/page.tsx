...
export const metadata: Metadata = {
  title: "All Footwear | VELOCE Atelier Catalog",
  description: "Explore our complete luxury and marathon performance footwear collection. Filter by carbon propulsion, calfskin sneakers, size, and bespoke colorways.",
};
